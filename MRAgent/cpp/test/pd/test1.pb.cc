...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_test1_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Person_PhoneNumber;
}  // namespace protobuf_test1_2eproto
namespace tutorial {
...
::google::protobuf::internal::SCCInfo<1> scc_info_Person =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsPerson}, {
      &protobuf_test1_2eproto::scc_info_Person_PhoneNumber.base,}};
...
const Person_PhoneNumber& Person_PhoneNumber::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_test1_2eproto::scc_info_Person_PhoneNumber.base);
...
Person::Person()
  : ::google::protobuf::MessageLite(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_test1_2eproto::scc_info_Person.base);
  SharedCtor();
...
const Person& Person::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_test1_2eproto::scc_info_Person.base);
  return *internal_default_instance();
}
