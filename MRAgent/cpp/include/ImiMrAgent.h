...
#define REF_POINTER(ref_type)                                                                                          \
    ...
    class MrAgentExceptionHandler
    {
        ...
        public:
            ...
            virtual void onExceptionHandle(MrAgentException exception,std::string error = "") {}
    };
    ...
    class IImiBaseDevice
    {
        private:
            ...
            std::atomic_bool isCmdClientRunning{true};
            ...
            // 正在获取属性
            std::atomic_bool isGettingProperty{false};
            std::string identity;
            std::atomic_bool isAuthenticating{false};
        protected:
        ...
        public:
            ...
            std::string authenticate(const std::string &uuid, const std::string &appkey,
                                     const std::string &algorithmVersion, const std::string license);
    ...
    class IImiBaseSensor
    {
        ...
        protected:
            ...
            MrManagerStatus getMrManagerStatus ()
            {
                if (m_pDevice)
                {
                    return m_pDevice->getMrManagerStatus();
                }
                return MrManagerStatus::NORMAL;
            }
            ...
            void setMrManagerNormalStatus () {
                if (m_pDevice)
                {
                    m_pDevice->setMrManagerNormalStatus();
                }
            }
    ...
    class IImiImageFrame : public IImiBaseFrame
    {
        ...
        public:
            ...
            virtual uint64_t getDataPointer() const
            {
                return 0;
            }
    ...
    class IImiColorFrame : public IImiImageFrame
    {
        ...
        public:
            ...
            virtual uint64_t getDataPointer() const override;
    ...
    class IImiUserTrackSensor : public IImiBaseSensor
    {
        ...
        private:
            ...
            void blockProcess (long now);
            void blockEvent (long now);
    ...
    typedef IBaseProperty<imimr::ImiSkImuData> ImiImuDataProperty;
