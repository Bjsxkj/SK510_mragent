...
namespace mrcore
{
    ...
    class MessageCore
    {
        public:
            ...
            void setMrManagerError (std::string error);
            ...
            bool initAuthentication(const char *configFilePath);
        ...
        private:
            ...
            void sendReplyToClient(std::string client_id, void * message , size_t len);
            void heartRecv();
            ...
            bool isColorSensorStarted = false;
            ...
            std::string authenticate(const std::string &uuid, const std::string &appkey, const std::string &algorithmVersion, const std::string platform, const std::string license);
