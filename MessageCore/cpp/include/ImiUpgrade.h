...
#ifndef _IMI_API_UPGRADE_H_
#define _IMI_API_UPGRADE_H_
...
enum IMI_UPGRADE_ERRCODE
{
	IMI_UPGRADE_TRANSFER_FILE_FAILED = -14,
	IMI_UPGRADE_FILE_SIZE_NOT_CORRECT = -13,
	IMI_UPGRADEERR_ENTER_RECOVERY_FAILED = -12,
...
IMINECT_EXP int32_t imiDeviceStartUpgradeOffLine(ImiDeviceHandle pDevice, const ImiUpgradeCallbacks* pCallbacks, const ImiUpgradeRomPath* pUpgradeRomPath ,uint8_t* version ,int32_t verLen,uint8_t* signRes ,int32_t sRLen);
